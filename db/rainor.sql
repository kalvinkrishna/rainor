...
--
-- Host: localhost
-- Generation Time: Nov 01, 2018 at 01:01 AM
...
(1, 1, 0, 'checkout', '2018-10-30 10:36:49', '2018-10-30 10:36:49'),
(6, 2, 0, 'checkout', '2018-10-30 12:43:23', '2018-10-30 12:43:23'),
(7, 2, 0, 'checkout', '2018-10-30 15:09:00', '2018-10-30 15:09:00'),
(8, 2, 0, 'checkout', '2018-10-30 15:09:00', '2018-10-30 15:09:00'),
(9, 2, 0, 'checkout', '2018-10-30 15:09:01', '2018-10-30 15:09:01'),
(10, 2, 0, 'checkout', '2018-10-30 15:09:01', '2018-10-30 15:09:01'),
(11, 1, 0, 'checkout', '2018-10-30 16:45:41', '2018-10-30 16:45:41'),
(12, 1, 0, 'checkout', '2018-10-30 16:45:41', '2018-10-30 16:45:41'),
(13, 1, 0, 'checkout', '2018-10-30 16:45:41', '2018-10-30 16:45:41'),
(14, 1, 0, 'checkout', '2018-10-30 16:45:41', '2018-10-30 16:45:41'),
(15, 1, 0, 'checkout', '2018-10-30 16:45:41', '2018-10-30 16:45:41'),
(16, 1, 0, 'checkout', '2018-10-30 16:45:42', '2018-10-30 16:45:42'),
(17, 1, 0, 'checkout', '2018-10-30 16:45:42', '2018-10-30 16:45:42'),
(18, 1, 0, 'checkout', '2018-10-30 16:45:42', '2018-10-30 16:45:42'),
(19, 1, 0, 'checkout', '2018-10-30 16:45:42', '2018-10-30 16:45:42'),
(20, 1, 0, 'checkout', '2018-10-30 16:45:42', '2018-10-30 16:45:42'),
(21, 1, 0, 'checkout', '2018-10-30 16:45:43', '2018-10-30 16:45:43'),
(22, 1, 0, 'checkout', '2018-10-30 16:45:43', '2018-10-30 16:45:43'),
(23, 1, 0, 'checkout', '2018-10-30 16:45:43', '2018-10-30 16:45:43'),
(24, 1, 0, 'checkout', '2018-10-30 16:45:43', '2018-10-30 16:45:43'),
(25, 1, 0, 'checkout', '2018-10-30 16:45:43', '2018-10-30 16:45:43'),
(26, 1, 0, 'checkout', '2018-10-30 16:45:44', '2018-10-30 16:45:44');
...
CREATE TABLE `categories` (
  `id` int(10) UNSIGNED NOT NULL,
  `nama_categories` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `categories` (`id`, `nama_categories`, `created_at`, `updated_at`) VALUES
(1, 'jaket', '2018-10-30 17:00:00', '2018-10-30 17:00:00'),
(2, 'celana', '2018-10-30 17:00:00', '2018-10-30 17:00:00');
...
INSERT INTO `categories_relation` (`id`, `id_product`, `categories`, `created_at`, `updated_at`) VALUES
(1, 1, 1, '2018-10-30 17:00:00', '2018-10-30 17:00:00'),
(2, 2, 1, '2018-10-30 17:00:00', '2018-10-30 17:00:00'),
(3, 3, 1, '2018-10-30 17:00:00', '2018-10-30 17:00:00'),
(4, 1, 2, '2018-10-30 17:00:00', '2018-10-30 17:00:00');
...
(3, '2018_10_15_013334_create_product_table', 1),
(4, '2018_10_15_013404_create_cart_table', 1),
(5, '2018_10_15_074539_add_column_categories_to_table_product', 1),
(6, '2018_10_15_075214_add_column_product_and_users_to_cart', 1),
(7, '2018_10_15_081221_create_productphoto_table', 1),
(8, '2018_10_16_060040_create_customer_table', 1),
(9, '2018_10_16_061902_create_order_table', 1),
(10, '2018_10_16_062614_create_transactionproduct_table', 1),
(11, '2018_10_16_155214_add_column_description_to_table_product', 1),
(12, '2018_10_21_101003_create_table_categories', 1),
(13, '2018_10_21_101629_create_table_categories_relation', 1),
(14, '2018_10_21_123329_update_colum_categories', 1),
(15, '2018_10_21_150334_change_column_data_categories_relation', 1),
(16, '2018_10_21_152350_change_column_data_categoryproduct', 1),
(17, '2018_10_22_133155_add_isbanner_to_product', 1),
(18, '2018_10_29_180328_created_product_variant_table', 1);
...
CREATE TABLE `product` (
  ...
  `categories` enum('pria','wanita','anak') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `product` (`id`, `product_name`, `description`, `categories`, `price`, `discount`, `tax`, `created_at`, `updated_at`, `isBanner`) VALUES
(1, 'Baju Kuli', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi sed sagittis metus. Donec viverra ligula ac libero vulputate, nec commodo urna porta. Cras purus libero, faucibus nec sodales sollicitudin, sagittis sed diam. Cras et dolor elit. Ut lacinia semper posuere. Maecenas tristique leo in turpis bibendum, vel vestibulum urna sollicitudin. Cras ac neque quis massa ultricies mollis. Vivamus pharetra dui vitae tortor tristique porttitor. Suspendisse ut ipsum eget libero varius lobortis ac nec urna. Aliquam volutpat justo ligula, nec facilisis elit suscipit bibendum. Pellentesque vehicula erat arcu. Fusce ullamcorper, nibh nec porttitor pharetra, nunc massa sagittis lorem, sollicitudin iaculis tellus tortor ac tortor. ', 'pria', 500000, 0, 0, '2018-10-30 17:00:00', '2018-10-30 17:00:00', 1),
(2, 'Baju Kancing', 'Ut ultrices, risus a sollicitudin semper, lorem dolor rhoncus purus, eu tempor lectus ipsum a justo. Pellentesque euismod elit nec eleifend semper. Curabitur vel velit ut ipsum interdum scelerisque. Vivamus cursus consectetur sem, ultricies iaculis justo egestas id. Nam nunc nunc, tempus eget scelerisque sit amet, vehicula et purus. Mauris volutpat dui vel risus vestibulum dignissim. Nullam ornare libero eget imperdiet bibendum. ', 'pria', 500000, 0, 0, '2018-10-30 17:00:00', '2018-10-30 17:00:00', 1),
(3, 'Baju Wanita', 'Nulla ullamcorper mi non suscipit consectetur. Morbi dapibus sit amet orci sit amet vestibulum. Nullam vel ligula feugiat, iaculis lorem at, congue enim. Suspendisse volutpat blandit faucibus. Ut condimentum sagittis sem eu posuere. Donec vel auctor purus. Fusce ac maximus mauris. Maecenas elementum pharetra erat, et tincidunt risus tempus ac. Phasellus finibus aliquet metus, eget scelerisque eros laoreet quis. Donec a congue metus, id placerat risus. ', 'wanita', 500000, 0, 0, '2018-10-30 17:00:00', '2018-10-30 17:00:00', 1);
...
(1, 1, 'aksarda.jpg', '2018-10-30 17:00:00', '2018-10-30 17:00:00');
...
INSERT INTO `productvariant` (`id`, `group`, `key`, `created_at`, `updated_at`) VALUES
(1, 'warna', 'hitam', '2018-10-30 17:00:00', '2018-10-30 17:00:00'),
(2, 'warna', 'biru', '2018-10-30 17:00:00', '2018-10-30 17:00:00'),
(3, 'ukuran', 'XL', '2018-10-30 17:00:00', '2018-10-30 17:00:00'),
(4, 'ukuran', 'L', '2018-10-30 17:00:00', '2018-10-30 17:00:00'),
(5, 'ukuran', 'S', '2018-10-30 17:00:00', '2018-10-30 17:00:00'),
(6, 'ukuran', 'M', '2018-10-30 17:00:00', '2018-10-30 17:00:00'),
(7, 'ukuran', 'XXL', '2018-10-30 17:00:00', '2018-10-30 17:00:00'),
(8, 'ukuran', 'SS', '2018-10-30 17:00:00', '2018-10-30 17:00:00');
...
ALTER TABLE `categories_relation`
  ADD PRIMARY KEY (`id`),
  ADD KEY `categories_relation_id_product_index` (`id_product`),
  ADD KEY `categories_relation_categories_index` (`categories`);
...
--
-- AUTO_INCREMENT for table `categories_relation`
--
ALTER TABLE `categories_relation`
...
--
ALTER TABLE `categories_relation`
  ADD CONSTRAINT `categories_relation_categories_foreign` FOREIGN KEY (`categories`) REFERENCES `categories` (`id`),
  ADD CONSTRAINT `categories_relation_id_product_foreign` FOREIGN KEY (`id_product`) REFERENCES `product` (`id`);
